...
Future<Address> callInfo(String keyword) async {
  String confmKey = 'U01TX0FVVEgyMDIyMDEzMDIwMzU0NTExMjE5NzU%3D';

  final http.Response response = await http.get(
    Uri.parse('https://www.juso.go.kr/addrlink/addrLinkApi.do?confmKey=' +
        confmKey +
        '&keyword=' +
        keyword +
        '&resultType=json'),
